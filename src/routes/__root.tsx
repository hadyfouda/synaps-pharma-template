...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: `SYNAPS — ${synapsConfig.company.name} — ${synapsConfig.company.productLine}` },
      { name: "description", content: `${synapsConfig.company.productLine} sales intelligence` },
      { property: "og:title", content: `SYNAPS — ${synapsConfig.company.name}` },
